...
export const DIAG_QUESTIONS: DiagQuestion[] = [
  ...
  // A1
  { band: 1, prompt: "Complete a frase: Je ___ Ana. (chamo-me)", options: ["m'appelle", "suis", "aime"], answer: 0 },
  ...
  { band: 1, prompt: "Complete a frase: Je ___ étudiante.", options: ["suis", "es", "ai"], answer: 0 },
  // A2
  { band: 2, prompt: "Complete a frase: Hier, j'___ mangé une pomme.", options: ["ai", "suis", "as"], answer: 0 },
  { band: 2, prompt: "'Où est la gare ?' pergunta…", options: ["onde fica a estação", "que horas são", "como você se chama"], answer: 0 },
  { band: 2, prompt: "Complete a frase: Nous ___ français.", options: ["sommes", "sont", "avez"], answer: 0 },
  { band: 2, prompt: "'Je vais manger' significa…", options: ["eu comi", "vou comer", "eu como sempre"], answer: 1 },
  // B1
  { band: 3, prompt: "Complete a frase: Si j'avais le temps, je ___ plus.", options: ["voyagerais", "voyage", "voyageais"], answer: 0 },
  { band: 3, prompt: "'Je ne peux pas venir' expressa…", options: ["impossibilidade", "desejo", "obrigação"], answer: 0 },
  { band: 3, prompt: "Complete a frase: Il faut que nous ___ tôt.", options: ["partons", "partions", "partirons"], answer: 1 },
  { band: 3, prompt: "Diferença entre 'savoir' e 'connaître'?", options: ["saber vs conhecer (pessoa/lugar)", "ser vs estar", "ir vs vir"], answer: 0 },
  // B2
  { band: 4, prompt: "Complete a frase: Bien qu'il ___ tard, il continue.", options: ["est", "soit", "sera"], answer: 1 },
  { band: 4, prompt: "Em 'le livre dont je parle', 'dont' refere-se a…", options: ["complemento com de", "complemento com à", "o sujeito"], answer: 0 },
  { band: 4, prompt: "Complete a frase: Si j'avais su, je ___ venu.", options: ["serais", "suis", "aurai"], answer: 0 },
  ...
  { band: 5, prompt: "Complete a frase: Je me demande ___ il pense.", options: ["ce que", "que", "qui"], answer: 0 },
  ...
  { band: 6, prompt: "Complete a frase: C'est le livre ___ je t'ai parlé.", options: ["dont", "que", "où"], answer: 0 },
